    ...
    <section class="position-absolute page-content">
        ...
        <div class="display-flex-row justify-content-between">
            ...
            <div>
                ...
                <button class="btn btn-primary btn-grn width-rem-12" onClick="completeTask('<?php echo $data['pdiVehicle']->ChassisNo ?>', '<?php echo $_SESSION['_id'] ?>')" <?php echo (($data['completeStatus']) ? '' : 'disabled') ;?>>Mark As Completed</button>
            </div>
        </div>
