<header>
    ...
    <ul class="display-flex-column height-100 gap-2 z-index-1">
        ...
        <li>
            ...
            <a class="<?php echo ($data['url'][1] == "pdiResults") ? 'active' : '' ; ?>" href="<?php echo URL_ROOT; ?>testers/pdiResults"><img src="<?php echo URL_ROOT; ?>public/images/icon2.png" class="width-rem-1p25" alt="icon2" />PDI Results</a>
        </li>
        <li>
