<header>
    ...
    <ul class="display-flex-column">
        ...
        <li>
            ...
            <a href="https://localhost/MicroCAPS/admins/manageemployees"><img src="<?php echo URL_ROOT; ?>public/images/icon7.png" class="width-rem-1p25" alt="icon7" />Manage Employees</a>
        ...
        <li>
            ...
            <a href="#"><img src="<?php echo URL_ROOT; ?>public/images/icon2.png" class="width-rem-1p25" alt="icon2" />Reports</a>
...
<header id="header" class="fixed-top display-flex align-items-start">
    <div class="container display-flex align-items-center justify-content-end">
        ...
        <div class="logout" id="logout"><a href="<?php echo URL_ROOT; ?>admins/logout" class="text-decoration-none text-black">logout</a></div>
        </div>
    </div>
</header>
