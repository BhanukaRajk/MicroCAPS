<header>
    ...
    <ul class="display-flex-column height-100 gap-2 z-index-1">
        ...
        <li>
            ...
            <a class="<?php echo ($data['url'][1] == "dashboard") ? 'active' : '' ; ?>" href="<?php echo URL_ROOT; ?>admins/dashboard"><img src="<?php echo URL_ROOT; ?>public/images/icon1.jpg" class="width-rem-1p25" alt="icon1" />Dashboard</a>
        <li>
            ...
            <a class="<?php echo ($data['url'][1] == "pdi") ? 'active' : '' ; ?>" href="<?php echo URL_ROOT; ?>admins/pdi"><img src="<?php echo URL_ROOT; ?>public/images/icon3.png" class="width-rem-1p25" alt="icon3" />PDI Results</a>
        ...
        <li>
            ...
            <a class="<?php echo ($data['url'][1] == "settings") ? 'active' : ''; ?>" href="<?php echo URL_ROOT; ?>admins/settings"><img src="<?php echo URL_ROOT; ?>public/images/icon5.png" class="width-rem-1p25" alt="icon5" />Settings</a>
        </li>
    </ul>
