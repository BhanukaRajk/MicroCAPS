...
<!-- <div class="item-2-2">
    <section class="position-absolute page-content">
        <div class="dash-graph-view test1">
            <canvas id="myChart"></canvas>
        </div>
        <div class="display-flex-column align-items-start border-radius-1 background-white padding-5 margin-top-3" id="calender">
            <div id="calender-title">May 2021</div>
