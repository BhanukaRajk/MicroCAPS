<header>
    ...
    <ul class="display-flex-column">
        ...
        <li>
            ...
            <a class="<?php echo ($data[1] == "dashboard") ? 'active' : '' ; ?>" href="<?php echo URL_ROOT; ?>supervisors/dashboard"><img src="<?php echo URL_ROOT; ?>public/images/icon1.jpg" class="width-rem-1p25" alt="icon1" />Dashboard</a>
        </li>
        <li>
            ...
            <a href="#"><img src="../images/icon6.png" class="width-rem-1p25" alt="icon6" />Schedule Tasks</a>
            <a href="#"><img src="../images/icon7.png" class="width-rem-1p25" alt="icon7" />Testing</a>
        </li>
        <li>
