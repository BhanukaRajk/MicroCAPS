    ...
    <div class="content">
        ...
        <div class="paq-form-margin">
            ...
            <div class="paq-form-box">
                <form method="POST" action="<?php echo 'URL_ROOT'; ?>Supervisors/updatePAQInspectionResults">
                    ...
                    <div class="paq-input-set-5">
                        ...
                        <div>
                            <input type="radio" id="option1" name="final_result" value="Passed">
                            <label for="option1">Passed</label>
                        </div>
                        <div>
                            <input type="radio" id="option2" name="final_result" value="Failed">
